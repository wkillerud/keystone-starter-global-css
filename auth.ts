...
if (!sessionSecret) {
  if (process.env.NODE_ENV === 'production') {
    ...
    sessionSecret = '-- DEV COOKIE SECRET; FEED ME YOUR SECRETS --';
  }
}
...
const isAccessAllowed = (context: KeystoneContext<BaseKeystoneTypeInfo>) => !!context.session?.data;

export { withAuth, isAccessAllowed, session };
